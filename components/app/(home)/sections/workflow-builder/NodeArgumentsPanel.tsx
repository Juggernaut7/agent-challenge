  ...
  return (
    <div className="space-y-16">
      <div className="flex items-center justify-between">
        <h3 className="text-label-small text-text-secondary">
          Arguments
        </h3>
        <button
            ...
            >
              <div className="flex items-start gap-8 mb-12">
                <div className="flex-1 grid grid-cols-2 gap-8">
                  ...
                  <input
                    ...
                    className="px-10 py-6 bg-main-bg border border-border-system rounded-6 text-body-small text-text-primary font-mono focus:outline-none focus:border-accent-green transition-colors"
                  />
                  ...
                  <select
                    ...
                    className="px-10 py-6 bg-main-bg border border-border-system rounded-6 text-body-small text-text-primary focus:outline-none focus:border-accent-green transition-colors"
                  >
              ...
              <div className="space-y-8">
                ...
                <input
                  ...
                  className="w-full px-10 py-6 bg-main-bg border border-border-system rounded-6 text-body-small text-text-primary font-mono focus:outline-none focus:border-accent-green transition-colors"
                />
              ...
              <div className="flex items-center justify-between mt-12 pt-12 border-t border-border-faint">
                <span className="text-body-small text-text-secondary">Required</span>
                <button
      ...
      {showAddArg && (
        ...
        >
          <p className="text-body-small text-text-primary mb-12">
      ...
      <details className="group">
        <summary className="cursor-pointer list-none p-12 bg-heat-4 rounded-8 border border-heat-100 text-body-small text-text-primary hover:bg-heat-8 transition-colors">
          📖 Variable Reference Guide
        </summary>
        <div className="mt-8 p-12 bg-heat-4 rounded-8 border border-heat-100 space-y-6 text-body-small text-text-primary font-mono">
          <div>
