    ...
    <AnimatePresence>
      {node && (
        <motion.aside
          ...
          className="fixed right-20 top-80 h-[calc(100vh-100px)] w-[calc(100vw-240px)] max-w-480 bg-card-bg border border-border-faint shadow-lg overflow-y-auto z-50 rounded-16"
        >
          {/* Header */}
          <div className="p-20 border-b border-border-faint">
            <div className="flex items-center justify-between mb-8">
              <input
                ...
                className="text-label-large text-text-primary font-medium bg-transparent border-none outline-none focus:outline-none hover:bg-white/5 px-2 -ml-2 rounded-4 transition-colors"
                placeholder="Enter node name..."
              />
              <div className="flex items-center gap-8">
                <button
                  onClick={() => onDelete(node?.id || '')}
                  className="w-32 h-32 rounded-6 hover:bg-white/5 transition-colors flex items-center justify-center group"
                  title="Delete node"
                >
                  <svg className="w-16 h-16 text-text-secondary group-hover:text-text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <>
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-12 py-10 bg-background-base border border-border-faint rounded-8 text-body-medium text-text-primary font-mono focus:outline-none focus:border-heat-100 transition-colors resize-none"
                  />
                ...
                <div className="p-16 bg-heat-4 rounded-12 border border-heat-100">
                  <h3 className="text-label-small text-text-primary mb-12 flex items-center gap-6">
                      ...
                      <div className="flex flex-wrap gap-6">
                        {availableVars.inputVars.map((v: any, idx: number) => (
                          <button
                            ...
                            className="px-10 py-6 bg-heat-8 hover:bg-heat-12 text-text-primary rounded-6 text-xs font-mono transition-colors"
                            title={v.description}
                          >
                            {v.path}
                          </button>
                ...
                <div className="p-16 bg-background-base rounded-12 border border-border-faint">
                  <h3 className="text-label-small text-text-primary mb-12">Common Patterns:</h3>
                  <div className="grid grid-cols-2 gap-8">
                    <button
                      onClick={() => setCondition('input.score > 70')}
                      className="text-left px-12 py-8 bg-card-bg hover:bg-heat-4 border border-border-faint rounded-6 transition-colors"
                    >
                      <p className="text-xs font-mono text-heat-100">input.score &gt; 70</p>
                      <p className="text-xs text-text-secondary mt-2">Number check</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-xs text-text-secondary mt-2">String equals</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-xs text-text-secondary mt-2">Array not empty</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-xs text-text-secondary mt-2">JSON nested</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-xs text-text-secondary mt-2">Range check</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-xs text-text-secondary mt-2">Array contains</p>
                    </button>
                  </div>
                </div>
              </>
              ...
              <>
                ...
                <div className="p-16 bg-background-base rounded-12 border border-border-faint">
                  ...
                  <div className="grid grid-cols-2 gap-8">
                    ...
                    >
                      ...
                      <p className="text-xs text-text-secondary mt-2">Fixed iterations</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-xs text-text-secondary mt-2">Array processing</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-xs text-text-secondary mt-2">Has more pages</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-xs text-text-secondary mt-2">Retry until good</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-xs text-text-secondary mt-2">Process queue</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-xs text-text-secondary mt-2">JSON array access</p>
                    </button>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-12 py-10 bg-background-base border border-border-faint rounded-8 text-body-medium text-text-primary focus:outline-none focus:border-heat-100 transition-colors"
                  />
                  <p className="text-body-small text-text-secondary mt-8">
              ...
              <>
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-12 py-10 bg-background-base border border-border-faint rounded-8 text-body-medium text-text-primary focus:outline-none focus:border-heat-100 transition-colors resize-none"
                  />
                  <p className="text-body-small text-text-secondary mt-8">
                ...
                <div className="p-16 bg-background-base rounded-12 border border-border-faint">
                  <h3 className="text-label-small text-text-primary mb-12">Common Message Patterns:</h3>
                  <div className="grid grid-cols-1 gap-8">
                    ...
                    >
                      ...
                      <p className="text-xs text-text-secondary mt-2">Simple approval with data</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-xs text-text-secondary mt-2">Financial approval</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-xs text-text-secondary mt-2">User action approval</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-xs text-text-secondary mt-2">Detailed approval with formatting</p>
                    </button>
                  </div>
                </div>
                ...
                <div className="p-16 bg-heat-4 rounded-12 border border-heat-100">
                  <h3 className="text-label-small text-text-primary mb-8">How it works</h3>
                  ...
                  <div className="flex gap-8 text-xs">
                    <div className="flex items-center gap-4">
                      ...
                      <span className="text-text-primary">Approve branch</span>
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-full bg-red-500"></div>
                      <span className="text-text-primary">Reject branch</span>
                    </div>
                  </div>
                </div>
              </>
