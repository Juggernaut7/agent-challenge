              ...
              <>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-12 py-10 bg-background-base border border-border-faint rounded-8 text-body-medium text-text-primary font-mono focus:outline-none focus:border-heat-100 transition-colors"
                  />
                ...
                <div className="flex items-center justify-between">
                  <label className="text-label-small text-text-primary">
              ...
              <>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-8 px-12 py-10 bg-background-base border border-border-faint rounded-8">
                    ...
                    <span className="text-body-small text-text-primary font-mono">{inputAsText}</span>
                    <span className="ml-auto px-8 py-4 bg-heat-4 text-heat-100 rounded-6 text-body-small font-medium">
                      STRING
                    </span>
                  </div>
                  <p className="text-body-small text-text-secondary mt-6">
                ...
                <div className="space-y-12">
                  {/* PII Detection */}
                  <div className="p-16 bg-card-bg border border-border-faint rounded-12">
                    <div className="flex items-center justify-between mb-12">
                      <div className="flex items-center gap-8">
                        ...
                        <span className="text-label-medium text-text-primary">PII Detection</span>
                      </div>
                      <button
                    ...
                    <div className="p-12 bg-heat-4 border border-heat-100 rounded-8">
                      <div className="flex items-start gap-8 mb-8">
                        ...
                        <div className="flex-1">
                          <p className="text-xs text-text-primary font-medium mb-4">What it does:</p>
                      ...
                      <div className="space-y-6 mt-10">
                        ...
                        <div>
                          <p className="text-xs text-text-primary font-medium flex items-center gap-4">
                  ...
                  <div className="p-16 bg-card-bg border border-border-faint rounded-12">
                    <div className="flex items-center justify-between mb-12">
                      <div className="flex items-center gap-8">
                        ...
                        <span className="text-label-medium text-text-primary">Content Moderation</span>
                      </div>
                      <button
                  ...
                  <div className="p-16 bg-card-bg border border-border-faint rounded-12">
                    <div className="flex items-center justify-between mb-12">
                      <div className="flex items-center gap-8">
                        ...
                        <span className="text-label-medium text-text-primary">Jailbreak Detection</span>
                      </div>
                      <button
                  ...
                  <div className="p-16 bg-card-bg border border-border-faint rounded-12">
                    <div className="flex items-center justify-between mb-12">
                      <div className="flex items-center gap-8">
                        ...
                        <span className="text-label-medium text-text-primary">Hallucination Detection</span>
                      </div>
                      <button
                  ...
                  <div className="space-y-16 pt-16 border-t border-border-faint">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-12 py-10 bg-background-base border border-border-faint rounded-8 text-body-medium text-text-primary focus:outline-none focus:border-heat-100 transition-colors cursor-pointer"
                      >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={4}
                        className="w-full px-12 py-10 bg-background-base border border-border-faint rounded-8 text-body-medium text-text-primary placeholder-black-alpha-32 focus:outline-none focus:border-heat-100 transition-colors resize-y font-mono"
                      />
                      <p className="text-body-small text-text-secondary mt-8">
      ...
      {showPIIModal && (
        ...
        >
          <motion.div
            ...
            className="bg-card-bg rounded-16 shadow-2xl w-[600px] max-h-[80vh] overflow-hidden flex flex-col"
          >
            {/* Header */}
            <div className="p-20 border-b border-border-faint bg-background-base">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-10">
                  ...
                  <div>
                    <h3 className="text-label-large text-text-primary">
            ...
            <div className="p-20 flex-1 overflow-y-auto">
              ...
              <div className="space-y-16">
                <div>
                  <h4 className="text-label-small text-text-primary mb-10">Common Types</h4>
                  <div className="grid grid-cols-2 gap-8">
                    {allPIIEntities.slice(0, 8).map((entity) => (
                      <label key={entity.id} className="flex items-center gap-8 p-10 hover:bg-background-base rounded-8 cursor-pointer transition-colors">
                        ...
                        />
                        <span className="text-body-small text-text-primary">{entity.label}</span>
                      </label>
                    ))}
                  </div>
                </div>
                ...
                <div>
                  <h4 className="text-label-small text-text-primary mb-10">US-Specific Types</h4>
                  <div className="grid grid-cols-2 gap-8">
            ...
            <div className="p-20 border-t border-border-faint bg-background-base flex justify-between items-center">
              ...
              <div className="flex gap-8">
                <button
                  onClick={() => setShowPIIModal(false)}
                  className="px-16 py-8 text-body-small text-text-primary hover:bg-white/5 rounded-8 transition-colors"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="px-20 py-8 bg-accent-black hover:bg-white/108 text-white rounded-8 text-body-small font-medium transition-colors"
                >
                  Save Changes
                </button>
              </div>
