        ...
        >
          ...
          <div className="p-16 border-b border-border-faint">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-title-h4 text-text-primary">HTTP Request</h3>
          ...
          <div className="p-16 space-y-16">
            ...
            <div>
              ...
              <div className="flex gap-8">
                <select
                  ...
                  className="px-12 py-8 bg-background-base border border-border-faint rounded-8 text-body-small text-text-primary font-medium focus:outline-none focus:border-heat-100 transition-colors"
                >
                ...
                <div className="flex-1 relative">
                  <input
                    ...
                    className="w-full px-12 py-8 pr-150 bg-background-base border border-border-faint rounded-8 text-body-small text-text-primary font-mono focus:outline-none focus:border-heat-100 transition-colors"
                  />
                  {nodes && (
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-12 py-8 bg-background-base border border-border-faint rounded-8 text-body-small text-text-primary focus:outline-none focus:border-heat-100 transition-colors mb-12"
              >
              ...
              {authType !== 'none' && (
                <div className="relative">
                  <input
                    ...
                    className="w-full px-12 py-8 pr-40 bg-background-base border border-border-faint rounded-8 text-body-small text-text-primary font-mono focus:outline-none focus:border-heat-100 transition-colors"
                  />
                  <button
            ...
            <div>
              <div className="flex items-center justify-between mb-8">
                <label className="block text-label-small text-text-secondary">
                  Headers
                </label>
                <div className="flex gap-6">
                  <button
                    onClick={() => insertQuickHeader('Content-Type', 'application/json')}
                    className="px-8 py-4 bg-background-base hover:bg-white/5 border border-border-faint rounded-4 text-body-small text-text-primary transition-colors"
                  >
                    + JSON
                  </button>
                  <button
                ...
                {headers.map((header, index) => (
                  <div key={index} className="flex gap-8">
                    <input
                      ...
                      className="flex-1 px-10 py-6 bg-background-base border border-border-faint rounded-6 text-body-small text-text-primary font-mono focus:outline-none focus:border-heat-100 transition-colors"
                    />
                    <input
                      type="text"
                      value={header.value}
                      ...
                      placeholder="value"
                      className="flex-1 px-10 py-6 bg-background-base border border-border-faint rounded-6 text-body-small text-text-primary focus:outline-none focus:border-heat-100 transition-colors"
                    />
                    <button
                      onClick={() => removeHeader(index)}
                      className="w-24 h-24 rounded-4 hover:bg-white/5 transition-colors flex items-center justify-center group"
                    >
                      <svg className="w-12 h-12 text-text-secondary group-hover:text-text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                      </svg>
                    </button>
                  </div>
              ...
              <div>
                ...
                <div className="flex gap-8 mt-8">
                  <button
                    ...
                    className="px-10 py-6 bg-heat-4 hover:bg-heat-8 border border-heat-100 rounded-6 text-body-small text-text-primary transition-colors"
                  >
                    Use Previous Output
                  </button>
                  <button
            ...
            <details className="group">
              ...
              <div className="mt-12 space-y-8">
                ...
                >
                  <p className="text-body-small text-text-primary font-medium">Slack Message</p>
                ...
                <button
                  ...
                  className="w-full p-10 bg-heat-4 hover:bg-heat-8 rounded-6 text-left border border-heat-100 transition-colors"
                >
                  <p className="text-body-small text-text-primary font-medium">Notion Page</p>
                ...
                <button
                  ...
                  className="w-full p-10 bg-heat-4 hover:bg-heat-8 rounded-6 text-left border border-heat-100 transition-colors"
                >
                  <p className="text-body-small text-text-primary font-medium">Zapier Webhook</p>
