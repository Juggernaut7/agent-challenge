      ...
      >
        ...
        <div className="p-20 border-b border-border-faint flex-shrink-0">
          <div className="flex items-center justify-between">
            <h2 className="text-title-h4 text-text-primary">Paste MCP Configuration</h2>
            <button
              onClick={onClose}
        ...
        <div className="p-20 space-y-16 overflow-y-auto flex-1">
          <div>
            <div className="flex items-center justify-between mb-4">
              <label className="text-body-small text-text-primary block">
                Configuration JSON
              </label>
              <a
    ...
    "firecrawl-mcp": {
      ...
      "env": {
        "FIRECRAWL_API_KEY": "your-api-key"
              ...
              className="w-full h-[300px] px-14 py-10 bg-background-base border border-border-faint rounded-10 text-sm text-text-primary font-mono focus:outline-none focus:border-heat-100 transition-colors resize-none"
              spellCheck={false}
            />
          </div>
          ...
          <div className="p-12 bg-heat-4 rounded-8 border border-heat-100">
            <div className="flex items-start gap-8">
              ...
              <div>
                <p className="text-body-small text-text-primary font-medium mb-4">
                  Supported Formats
                </p>
                <p className="text-body-small text-text-primary mb-6">
