          ...
          {schema.map((field, index) => (
            ...
            >
              ...
              <input
                ...
                className="w-full px-10 py-6 bg-main-bg border border-border-system rounded-6 text-body-small text-text-secondary focus:outline-none focus:border-accent-green transition-colors"
              />
            </motion.div>
          ))}
        </div>
