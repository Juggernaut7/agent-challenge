      ...
      case "boolean":
        return (
          <select
            ...
            className="w-full px-12 py-8 bg-card-bg border border-border-faint rounded-8 text-sm text-text-primary focus:outline-none focus:border-heat-100 transition-colors"
          >
      ...
      case "number":
        return (
          <input
            ...
            className="w-full px-12 py-8 bg-card-bg border border-border-faint rounded-8 text-sm text-text-primary font-mono focus:outline-none focus:border-heat-100 transition-colors"
          />
        );
      case "json":
        return (
          <textarea
            ...
            className="w-full px-12 py-8 bg-card-bg border border-border-faint rounded-8 text-sm text-text-primary font-mono focus:outline-none focus:border-heat-100 transition-colors resize-none"
          />
        );
      case "expression":
        return (
        ...
        >
          ...
          <div className="p-20 border-b border-border-faint">
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-label-large text-text-primary font-medium">
              ...
              <div className="flex items-center gap-8">
                ...
                >
                  <svg
                    className="w-16 h-16 text-text-secondary group-hover:text-text-primary"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
          ...
          <div className="p-20 space-y-24">
            ...
            {nodeType.includes("transform") && (
              <>
                <div>
                  <h3 className="text-sm font-medium text-text-primary mb-12">
                  ...
                  <div className="space-y-12">
                    <div className="p-12 bg-background-base rounded-10 border border-border-faint">
                      <div className="space-y-12">
                        {/* Variable Name */}
                        <div>
                          <label className="block text-sm text-text-primary mb-6">
                            Variable Name
                          </label>
                          <input
                            type="text"
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className="w-full px-12 py-8 bg-card-bg border border-border-faint rounded-8 text-sm text-text-primary focus:outline-none focus:border-heat-100 transition-colors appearance-none cursor-pointer"
                          >
                    ...
                    <button
                      ...
                      className="px-12 py-8 bg-background-base hover:bg-white/5 border border-border-faint rounded-8 text-sm text-text-primary transition-colors flex items-center gap-6"
                    >
                      <svg
                        className="w-14 h-14"
                        fill="none"
