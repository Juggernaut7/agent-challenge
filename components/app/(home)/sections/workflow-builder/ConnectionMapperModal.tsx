          ...
          >
            ...
            <div className="p-24 border-b border-border-faint">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-title-h3 text-text-primary">Map Connection</h2>
            ...
            <div className="p-24 space-y-20">
              ...
              <div className="space-y-12">
                <div className="grid grid-cols-2 gap-12 pb-12 border-b border-border-faint">
                  <p className="text-label-small text-text-secondary">From ({sourceData.nodeName})</p>
                  <p className="text-label-small text-text-secondary">To ({targetData.nodeName})</p>
                </div>
                ...
                {targetKeys.map((targetKey) => (
                  <div key={targetKey} className="grid grid-cols-2 gap-12 items-center">
                    <select
                      ...
                      className="px-12 py-8 bg-background-base border border-border-faint rounded-6 text-body-small text-text-primary font-mono focus:outline-none focus:border-heat-100 transition-colors"
                    >
                    ...
                    <div className="flex items-center gap-8">
                      ...
                      <code className="text-body-small text-text-primary font-mono">{targetKey}</code>
                    </div>
                  </div>
                ))}
              </div>
