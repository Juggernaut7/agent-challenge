      ...
      {node && (
        ...
        >
          ...
          <div className="p-20 border-b border-border-faint bg-heat-4">
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-8">
                ...
                <h2 className="text-title-h3 text-text-primary">Sticky Note</h2>
              </div>
              <div className="flex items-center gap-8">
                <button
                  ...
                  title="Delete note"
                >
                  <svg className="w-16 h-16 text-heat-100 group-hover:text-text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="p-20">
            {/* Sticky Note */}
            <div>
              <label className="block text-sm font-medium text-text-primary mb-8 flex items-center gap-8">
                <svg className="w-16 h-16 text-heat-100" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <textarea
                ...
                className="w-full px-14 py-10 bg-heat-4 border border-heat-100 rounded-10 text-sm text-text-primary placeholder-black-alpha-48 placeholder:opacity-50 focus:outline-none focus:border-heat-100 transition-colors resize-y font-sans"
