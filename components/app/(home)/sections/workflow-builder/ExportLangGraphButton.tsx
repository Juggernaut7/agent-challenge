...
export function ExportLangGraphButton({ workflowId, workflowName }: ExportLangGraphButtonProps) {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-text-primary bg-main-bg border border-border-system rounded-md hover:bg-white/5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent-green"
    >
