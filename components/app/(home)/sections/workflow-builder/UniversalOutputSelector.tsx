...
export default function UniversalOutputSelector({
  ...
  return (
    <div className="space-y-12">
      <div>
        <label className="block text-body-small text-text-secondary mb-6 font-medium">
          Output Format
        </label>
        <p className="text-body-small text-text-secondary mb-10">
        ...
        <div className="space-y-8">
          ...
          >
            <p className="text-body-small text-text-primary font-medium mb-4">Full Output</p>
          ...
          >
            <p className="text-body-small text-text-primary font-medium mb-4">Extract Field</p>
            <p className="text-body-small text-text-secondary">
          ...
          {outputAs === 'field' && (
            <div className="ml-16 pl-12 border-l-2 border-heat-100">
              <label className="block text-body-small text-text-secondary mb-6">
                Field Name
              </label>
              <select
                value={fieldName}
                onChange={(e) => setFieldName(e.target.value)}
                className="w-full px-10 py-6 bg-main-bg border border-border-system rounded-6 text-body-small text-text-primary font-mono focus:outline-none focus:border-accent-green transition-colors mb-8"
              >
          ...
          >
            <p className="text-body-small text-text-primary font-medium mb-4">Custom Path</p>
            <p className="text-body-small text-text-secondary">
