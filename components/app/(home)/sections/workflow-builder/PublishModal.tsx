    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 bg-white/58 z-[100] flex items-center justify-center p-20"
          onClick={onClose}
        >
          <motion.div
            ...
            className="bg-card-bg rounded-16 shadow-2xl max-w-600 w-full max-h-[80vh] overflow-y-auto"
          >
            {!published ? (
              <>
                {/* Header */}
                <div className="p-24 border-b border-border-faint">
                  <div className="flex items-center justify-between">
                    <h2 className="text-title-h3 text-text-primary">Publish Workflow</h2>
                    <button
                      onClick={onClose}
                ...
                <div className="p-24 space-y-20">
                  ...
                  <div className="flex items-center justify-between p-16 bg-background-base rounded-12 border border-border-faint">
                    <div>
                      <h3 className="text-label-small text-text-primary mb-4">Public Access</h3>
                  ...
                  <div className="flex items-center justify-between p-16 bg-background-base rounded-12 border border-border-faint">
                    <div>
                      <h3 className="text-label-small text-text-primary mb-4">Require Authentication</h3>
                      <p className="text-body-small text-text-secondary">
                ...
                <div className="p-24 border-t border-border-faint flex items-center justify-between">
                  <button
                    onClick={onClose}
                    className="px-20 py-10 text-body-medium text-text-secondary hover:text-text-primary transition-colors"
                  >
                    Cancel
                  </button>
                  <button
              ...
              <>
                ...
                <div className="p-24">
                  <div className="text-center mb-24">
                    ...
                    <h2 className="text-title-h3 text-text-primary mb-8">Workflow Published!</h2>
                  ...
                  <div className="mb-24">
                    ...
                    <div className="flex gap-8">
                      <div className="flex-1 px-12 py-10 bg-background-base border border-border-faint rounded-8 text-body-small text-text-primary font-mono overflow-x-auto">
                        {endpointUrl}
                      </div>
                      <button
                        onClick={handleCopyEndpoint}
                        className="px-16 py-10 bg-background-base hover:bg-white/5 border border-border-faint rounded-8 text-body-small text-text-primary transition-colors"
                      >
                        Copy
                      </button>
                    </div>
