    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 bg-white/58 z-[200] flex items-center justify-center p-20"
          onClick={onClose}
        >
          <motion.div
            ...
            className="bg-card-bg rounded-16 shadow-2xl max-w-400 w-full"
          >
            {/* Header */}
            <div className="p-20 border-b border-border-faint">
              <h2 className="text-title-h4 text-text-primary">Edit Connection</h2>
            ...
            <div className="p-20 space-y-16">
              ...
              <div>
                ...
                <div className="space-y-8">
                  ...
                  >
                    <p className="text-body-small text-text-primary font-medium">No Label</p>
                    <p className="text-body-small text-text-secondary mt-4">Standard connection</p>
                  </button>
                  ...
                  >
                    <p className="text-body-small text-text-primary font-medium">True Branch</p>
                    <p className="text-body-small text-text-secondary mt-4">For If/Else true condition</p>
                  </button>
                  ...
                  >
                    <p className="text-body-small text-text-primary font-medium">False Branch</p>
                    <p className="text-body-small text-text-secondary mt-4">For If/Else false condition</p>
                  </button>
                  ...
                  >
                    <p className="text-body-small text-text-primary font-medium">Custom Label</p>
                    <p className="text-body-small text-text-secondary mt-4">Your own text</p>
                  </button>
                </div>
              </div>
              ...
              {labelType === 'custom' && (
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-12 py-8 bg-background-base border border-border-faint rounded-8 text-body-medium text-text-primary focus:outline-none focus:border-heat-100 transition-colors"
                  />
                </div>
              )}
            </div>
